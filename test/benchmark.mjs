...
const patch = installPresentation(loadConfig('work/missing').config, Pi.VERSION, console.error, { pi: Pi, tui: Tui });
try {
  const compact = { collapsed: sample(false), expanded: sample(true) };
  console.log(JSON.stringify({ node: process.version, pi: Pi.VERSION, platform: `${platform()}-${arch()}`, workload: { turns: 40, callsPerTurn: 8, resultLines: 12, width: 100, samples: 7 }, native, compact }, null, 2));
